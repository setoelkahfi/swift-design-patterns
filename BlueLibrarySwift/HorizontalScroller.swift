...
@objc protocol HorizontalScrollerDelegate {
    ...
    // ask the delegate how many viewa he wants to present inside the horizontal scroller
    ...
    // ask the delegate for the indec of the initial view to display, this method is optional
    // and defaults to 0 if it's not implemented by delegate
...
class HorizontalScroller: UIView {
    ...
    */
    ...
    private var scroller: UIScrollView = UIScrollView()
    ...
    func reload() {
        // 1 - Check if there is a delegate, if not, there's nothing to load.
        if let delegate = delegate {
